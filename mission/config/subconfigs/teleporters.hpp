class objects
{
	...
	{
		destinations[] = {"mikeforce_base", "acav_base", "spiketeam_base", "macv_base"};
	};

	class vn_mf_spiketeam_teleporter
	{
		destinations[] = {"mikeforce_base", "acav_base", "greenhornets_base", "macv_base"};
	};

	class vn_mf_mikeforce_teleporter
	{
		destinations[] = {"acav_base", "spiketeam_base", "greenhornets_base", "macv_base"};
	};
	...
	{
		destinations[] = {"quarterhorse_base", "7th_cav_base", "3rdMEU_base",  "arvn_base", "633rd_base"};
	};
	...
	{
		destinations[] = {"sa_base", "mikeforce_base", "acav_base", "spiketeam_base", "greenhornets_base", "macv_base"};
	};

	class vn_mf_sa_teleporter
	{
	...
	class dc_tunnel_1_low_N
	{
		destinations[] = {"da_nang"};
	};

	class dc_tunnel_1_low_S
	{
		destinations[] = {"ba_ria"};
	};
	...
	{
		destinations[] = {"ban_hoang"};
	};

	class dc_tunnel_1_mid_N_2
	{
		destinations[] = {"da_nang"};
	};
	...
	class dc_tunnel_1_top_N //redbull can
	{
		destinations[] = {"mikeforce_base", "greenhornets_base", "acav_base"};
	};
...
class destinations
{
	...
	class sasr_base
	{
		image = "custom\taskroster\BN_ANZAC_patch.paa"; 
